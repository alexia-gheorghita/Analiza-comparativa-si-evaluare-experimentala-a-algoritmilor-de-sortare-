...
//GENERARE VECTOR SORTAT INVERS
void generateReversedVector(int v[], int n) {
    for (int i = 0; i < n; i++) {
        v[i] = n - i;
    }
}
...
int main() {
    ...
    cout << "Rulare experiment: VECTOR SORTAT INVERS (" << num_tests << " repetari, N = " << n << ")" << endl;
    cout << "Analiza comportamentului in cel mai nefavorabil caz (Worst Case)..." << endl << endl;

    for (int t = 0; t < num_tests; t++) {
        generateReversedVector(original, n);
